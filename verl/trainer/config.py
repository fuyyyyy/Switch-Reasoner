...
class DataConfig:
    ...
    def post_init(self):
        ...
        self.user_prompt = get_abs_path(self.user_prompt, prompt="User prompt file")
        self.user_direct_prompt = get_abs_path(self.user_direct_prompt, prompt="User direct prompt file")
        self.user_think_prompt = get_abs_path(self.user_think_prompt, prompt="User think prompt file")
