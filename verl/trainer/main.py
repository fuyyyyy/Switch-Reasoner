...
class Runner:
    ...
    def run(self, config: PPOConfig):
        ...
        train_dataloader, val_dataloader = create_dataloader(config.data, tokenizer, processor, filter_log_dir=os.path.join(config.trainer.save_checkpoint_path, "filter_log"))
